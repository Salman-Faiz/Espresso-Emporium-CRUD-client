    ...
    <div className="font-customFont text-yellow-950">
      ...
      <div className="grid md:grid-cols-2 gap-10 md:px-32 bg-PopularBg2 bg-no-repeat bg-right bg-opacity-100">
        <div className="flex items-center bg-slate-100 rounded-lg bg-opacity-50 shadow-lg justify-evenly">
          <img className="" src="/public/images/1.png" alt="" />
        ...
        <div className="flex items-center bg-slate-100 rounded-lg bg-opacity-50 shadow-lg justify-evenly">
          <img className="" src="/public/images/2.png" alt="" />
          <div className="text-lg space-y-3 ">
            <h2>
              <span className="font-bold">Name:</span>Espresso Coffee{" "}
            </h2>
            <h2>
              <span className="font-bold">Chef:</span>Mrs. Morisha
            </h2>
            <h3>
              {" "}
              <span className="font-bold">Price :</span>890 Taka
        ...
        <div className="flex items-center bg-slate-100 rounded-lg bg-opacity-50 shadow-lg justify-evenly">
          <img className="" src="/public/images/3.png" alt="" />
          <div className="text-lg space-y-3 ">
            <h2>
              <span className="font-bold">Name:</span> Black Coffee
            </h2>

            <h2>
              <span className="font-bold">Chef:</span>Mr.Nibra Sweden
            </h2>
            <h3>
              {" "}
              <span className="font-bold">Price :</span>890 Taka
        ...
        <div className="flex items-center bg-slate-100 rounded-lg bg-opacity-50 shadow-lg justify-evenly ">
          <img className="" src="/public/images/4.png" alt="" />
          <div className="text-lg space-y-3 ">
            <h2>
              <span className="font-bold">Name:</span>Decaf Coffee
            </h2>
        ...
        <div className="flex items-center bg-slate-100 rounded-lg bg-opacity-50 shadow-lg justify-evenly">
          <img className="" src="/public/images/5.png" alt="" />
          <div className="text-lg space-y-3 ">
            <h2>
              <span className="font-bold">Name:</span>Macchiato
            </h2>
        ...
        <div className="flex items-center bg-slate-100 rounded-lg bg-opacity-50 shadow-lg justify-evenly ">
          <img className="" src="/public/images/6.png" alt="" />
          <div className="text-lg space-y-3 ">
            <h2>
            ...
            <h2>
              <span className="font-bold">Chef:</span>Mr.Moruti
            </h2>
            <h3>
              {" "}
              <span className="font-bold">Price :</span>890 Taka
